...
class Questions {
    ...
    pushQuestion2Quiz(langName, questionInfo, questionName) {
        ...
        questionInfo.langName = langName;
    ...
    getQuestion(langName, level) {
        ...
        if (process.env.DEBUG) {
            ...
            console.log('Image path:' + path.join(__dirname, '../quiz', question.langName, question.name) + '/code.png');
        }
        return {
            imagePath: path.join(__dirname, '../quiz', question.langName, question.name) + '/code.png',
            description: question.question + ' (' + question.langName + ')',
